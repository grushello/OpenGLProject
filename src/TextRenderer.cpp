...
TextRenderer::TextRenderer(unsigned int width, unsigned int height)
{
    ...
    std::string vertexPath = str_dir + "/shaders/text.vrt";
    std::string fragmentPath = str_dir + "/shaders/text.frg";

    this->TextShader = ResourceManager::LoadShader(vertexPath.c_str(), fragmentPath.c_str(), nullptr, "text");
